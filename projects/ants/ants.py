...
class Place:
    ...
    def __init__(self, name, exit=None):
        ...
        if exit is not None:
            exit.entrance = self  # Set the entrance of the exit to this Place
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant():
            ...
            if isinstance(insect, BodyguardAnt):
                if self.ant is None:
                    self.ant = insect
                elif isinstance(self.ant, BodyguardAnt):
                    self.ant = insect
                else:
                    raise AssertionError("Cannot add more than one Ant to this Place")
