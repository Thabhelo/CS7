...
partner_one_email = "thabheloduve@gmail.com"
partner_two_email = "gettyhncube@gmail.com"
assignment = "hog"
...
def roll_dice(num_rolls, dice=six_sided):
    ...
    total = 0
    have_a_one_outcome = False
    while num_rolls > 0:
        current_roll = dice()
        if current_roll == 1:
            have_a_one_outcome = True #pig out rule, you cannot return as of now, it will distrub the while loop
        else:
            total += current_roll
        num_rolls -= 1
    if have_a_one_outcome:
        return 1
    else:
        return total
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        opponent_score = 1 + max((num_rolls // 10), (num_rolls % 10)) #freebacon
...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    while score < goal and opponent_score < goal:
        if who == 0:
            ...
            score += take_turn(num_rolls, opponent_score, dice) # the result should be added to score
        elif who == 1:
